...
/**
 * <p>Java class for ProvierType complex type.
 * 
 ...
 *       &lt;sequence>
 *         &lt;element name="provider-Id" type="{http://cs548.stevens.edu/clinic/service/web/rest/data/dap}LinkType"/>
...
@XmlType(name = "ProvierType", propOrder = {
    "providerId",
    "npi",
    "name",
    "specialization",
...
public class ProvierType {

    @XmlElement(name = "provider-Id", required = true)
    protected LinkType providerId;
     ...
     *     
     */
    public void setProviderId(LinkType value) {
